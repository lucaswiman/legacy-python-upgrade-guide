...
REMOVALS_AND_RENAMES.extend([
    ...
    'types.FileType',
    ['types.EllipsisType', 'type(Ellipsis)', True],
    ['types.ListType', 'list', True],
    ['types.TupleType', 'tuple', True],
    'types.LongType',
    'types.BufferType',
    'types.ClassType',
    ['types.UnicodeType', 'six.text_type', True],
    ['types.ComplexType', 'complex', True],
    'types.ObjectType',
    'types.XRangeType',
    ['types.NoneType', 'type(None)', True],
